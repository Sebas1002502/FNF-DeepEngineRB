...
:: Core
echo [1/15] hxcpp
haxelib git hxcpp https://github.com/Sebas1002502/hxcpp --quiet
...
:: HaxeFlixel
echo [4/15] flixel
haxelib haxelib install flixel 6.2.0  --quiet
...
haxelib git hscript-iris https://github.com/Sebas1002502/hscript-iris.git --quiet
...
haxelib git linc_luajit https://github.com/MAJigsaw77/hxluajit.git --quiet
